...
<section class="content pr-3 pl-3">
        <div class="row">
            ...
            <br />
            <div class="card-body">
            {!! Form::open(array('url' => URL::to('admin/testimonial/testimonials'), 'method' => 'post', 'class' => 'bf', 'files'=> true)) !!}
            {{-- {!! Form::open(['route' => 'admin.testimonial.testimonials.store']) !!} --}}

                @include('admin.testimonial.testimonials.fields')
