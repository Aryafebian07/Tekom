...
@section('content')
    <!-- Map Section Start -->
    <div class="">
            <iframe src="https://www.google.com/maps/embed?pb=!1m14!1m8!1m3!1d15843.022809811013!2d106.912771!3d-6.919782!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x0%3A0xecbbf1784114f3d8!2sPoliteknik%20Sukabumi!5e0!3m2!1sen!2sid!4v1573439269454!5m2!1sen!2sid" width="800" height="600" frameborder="0" style="border:0;" allowfullscreen=""></iframe>
    </div>
    <!-- //map Section End -->
            ...
            <div class="col-md-6 col-sm-6" id="address_margt">
                <div class="media media-top media-right">
                    ...
                    <div class="media-body ml-3">
                        ...
                        <div class="danger">Politeknik Sukabumi</div>
                        <address>
                                Jl. Babakan Sirna No. 25 Benteng
                                <br>Kota Sukabumi,
                                <br>Jawa Barat.
                        </address>
                    </div>
                ...
                <div class="media media-top">
                    ...
                    <div class="media-body ml-3">
                        <h4 class="media-heading">Telephone:</h4>0852 1086 8034(Whatsapp)
                        <br /> Fax:(0266)215417
                    </div>
                </div>
            </div>
